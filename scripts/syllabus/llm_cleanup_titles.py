...
# ── Config ─────────────────────────────────────────────────────────────────
INPUT_PATH  = "akos/syllabus/courses.json"
OUTPUT_PATH = "akos/syllabus/courses_llm_clean.json"
OLLAMA_URL  = "http://localhost:11434/api/generate"
OLLAMA_MODEL = "llama3"          # Change to your model: mistral, phi3, etc.
USE_LLM = False              # Set False to run rule-based cleanup only (faster test)

...
from pipeline.common.embedding_config import load_embedding_config as load_common_embedding_config, load_sentence_transformer  # noqa: E402
...
def load_embedding_config() -> Dict[str, Any]:
    ...
    """
    try:
        emb = load_common_embedding_config(CONFIG_PATH)
        return {
...
class SemanticBoundaryDetector:
    ...
    def __init__(self, model_name: str = EMBEDDING_MODEL):
        ...
        self.model = load_sentence_transformer(load_common_embedding_config(CONFIG_PATH))
